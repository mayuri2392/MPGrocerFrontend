        ...
        <div>
          <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
            <div className="container">
              <Link className="navbar-brand" to="/">MP Grocer</Link>
              ...
              <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div className="navbar-nav">
                  ...
                  {
                    ( auth ) ? 
                      ( <a className="nav-item nav-link float-end" href="/" onClick={this.logOut}>Log out</a>) : 
                      ( <Link className="nav-item nav-link float-end" to="/login">Log in</Link> )
                   }
                </div>
              </div>
            </div>
